...
INSERT INTO drink_order (id, customer_id, ordered_at, total_amount, order_status)
VALUES (null, 101, '2024-02-26', 15.99, 'completed'),
...
SELECT id,
       ...
       CASE
           ...
           ELSE 'Unknown status'
           END AS status_description
FROM drink_order; -- 동등비교 외에도 무긍무진한 활용
